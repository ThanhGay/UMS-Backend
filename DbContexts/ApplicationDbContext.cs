...
namespace Server.DbContexts
{
    public class ApplicationDbContext : DbContext
    {
        ...
        {
            modelBuilder
                .Entity<MonHoc_ChuongTrinhKhung>()
                .HasOne<ChuongTrinhKhung>()
                .WithMany()
                .HasForeignKey(_ => _.ChuongTrinhKhungId)
                .OnDelete(DeleteBehavior.Restrict);
            modelBuilder
                .Entity<LopHP_Room>()
                .HasOne<LopHP>()
                .WithMany()
                .HasForeignKey(s => s.LopHpId)
            ...
            modelBuilder
                ...
                .OnDelete(DeleteBehavior.Restrict);
            modelBuilder
                .Entity<LopHP_Student>()
                .HasOne<LopHP>()
                .WithMany()
                .HasForeignKey(_ => _.LopHpId)
                .OnDelete(DeleteBehavior.Cascade);
            modelBuilder
                .Entity<LopHP_Teacher>()
                .HasOne<LopHP>()
                .WithMany()
                .HasForeignKey(_ => _.LopHpId)
                .OnDelete(DeleteBehavior.Cascade);
